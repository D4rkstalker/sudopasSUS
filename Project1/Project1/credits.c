...
void credits_button(int button, int* buttonalpha) {
	if (CP_Input_GetMouseWorldX() >= (float) CP_System_GetWindowWidth() / 2 - 450 && CP_Input_GetMouseWorldX() <= (float) CP_System_GetWindowWidth() / 2 + 450 && CP_Input_GetMouseWorldY() >= 350.0f + CreditsY + CreditsH - 50 && CP_Input_GetMouseWorldY() <= 350.0f + CreditsY + CreditsH + 50) {
		*buttonalpha = 50;
...
void draw_copyrightSymbol(float size, float dist) {
	...
	CP_Graphics_DrawCircle(((float) CP_System_GetWindowWidth() / 2) + 200, 350.0f + CreditsY + CreditsH - 95, 65);
	CP_Settings_Fill(CP_Color_Create(255, 255, 255, 255));
	CP_Font_DrawText("C", ((float) CP_System_GetWindowWidth() / 2) + 200, 350.0f + CreditsY + CreditsH - 100);
	CreditsH += dist;
}
...
void credit_scene(void) {
	...
	if (CheckPoint_3_Triggered == 1) {
		...
		CP_Font_DrawText("GAME CLEAR!", (float) CP_System_GetWindowWidth() / 2, 350.0f + CreditsY + CreditsH);
		CreditsH += 700;
	}
	...
	CP_Graphics_DrawRect((float) CP_System_GetWindowWidth() / 2, 350.0f + CreditsY + CreditsH, 900, 100);
